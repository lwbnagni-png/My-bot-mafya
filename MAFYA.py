...
USERNAME = "MAFYA123"
PASSWORD = "Bn_1411"
BOT_TOKEN = "8055534365:AAHSuUBy9cwXC2NWVKQH0gzQN-JdA3jSzFA"
CHAT_IDS = [
    " -1003880219722",
]
REFRESH_INTERVAL = 3
...
def send_welcome(message):
    ...
    if is_maintenance_mode() and not is_admin(user_id):
        maintenance_caption = (
            "<b>❍─── <u>𝐖𝐞𝐥𝐜𝐨𝐦 𝐭𝐨  𝐾𝐴𝑅𝐿𝑌 YT😍💪 𝐵𝑂𝑇</u> ───❍</b>\n\n"
    ...
    fancy_text = (
        "<b>❍<u>𝐖𝐞𝐥𝐜𝐨𝐦 𝐭𝐨 𝑲𝑨𝑹𝑳𝒀 𝑩𝑶𝑻 </u>❍</b>\n\n"
        "<b>🔋 <u>𝐅𝐚𝐬𝐭  • 𝐒𝐞𝐜𝐮𝐫𝐞  • 𝐨𝐧𝐥𝐢𝐧𝐞</u></b>\n\n"
        "<b>🎓 <u>𝐎𝐰𝐧𝐞𝐫</u>  • <a href='tg://user?id=8526412687'>𝑲𝑨𝑹𝑳𝒀</a></b>\n\n"
        "<b>────────────────────</b>\n"
...
def handle_country_selection(call):
    ...
    # زر الجروب في الأعلى
    markup.add(types.InlineKeyboardButton("👥 𝐎𝐓𝐏 𝐆𝐑𝐎𝐔𝐏", url="https://t.me/+PH0CurlnDMIwMDdk"))
    ...
    try:
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [
                    {"text": "💬 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ↗️", "url": "https://t.me/jhuujh98"},
                    {"text": "🤖 𝐁𝐎𝐓 𝐏𝐀𝐍𝐄𝑳 ↗️", "url": "@Mafya_otp_ff_bot"}
                ],
